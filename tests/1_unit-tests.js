...
describe('ConvertHandler Tests', () => {
  ...
  it('should throw an error for invalid number format', () => {
    expect(() => convertHandler.getNum('invalid')).to.throw('invalid num');
    expect(() => convertHandler.getNum('10/0')).to.throw('invalid num');
  });
  ...
  it('should throw an error for invalid unit', () => {
    expect(() => convertHandler.getUnit('10invalid')).to.throw('invalid unit');
  });
